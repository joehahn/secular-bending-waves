...
Ntimes = 501                                                    ;number of outputs in time-evolution
...
Nrings=500                                     ;total number of rings
Nr_inner=0                                    ;number of rings orbiting interior to perturber
Nr_outer=Nrings-Nr_inner              ;number of rings orbiting exterior to perturber
a_min=1.0                                    ;inner ring radius (AU)
a_max=1.015                                   ;outer ring radius (AU)
delta=0.0005                                     ;gap half width (AU)
